...
while budget >= one_bread_price:
    ...
    breads_counter += 1
    colore_eggs_counter += 3
    if breads_counter % 3 == 0:
        colore_eggs_counter -= breads_counter - 2
print(f"You made {breads_counter} loaves of Easter bread! Now you have {colore_eggs_counter} eggs and {budget:.2f}BGN left.")